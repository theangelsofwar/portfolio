from google.com import language
...
#URL for GET request to wikidata API with string parameter =SPARQL query
    WIKIDATA_QUERY_URL="https://query.wikidata.org/sparql?query=%sformat=JSON"


    #A wikidata SPARQL query to find stock ticker symbols and other information for a company with string parameter=Freebase ID of company
    MID_TO_TICKER_QUERY=('SELECT ?companyLabel ?rootLabel ?tickerLabel ?exchangeNameLabel'
    ' WHERE {'
